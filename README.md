...
- **ISO 31000 Risk Assessment** — Full risk register and controls catalogue  
- **Incident Response Plan (Team Two Factor)**  
- **Web Development Portfolio** (HTML, CSS, multimedia)  
- **Linux Practice Labs**  
- **Cybersecurity Mini Projects** (Nmap, Wireshark, password strength tool)

More projects coming soon as I build my cybersecurity skillset!
...
- Linux (Basic Navigation & Permissions)  
...
## 📫 Connect With Me
- **LinkedIn:** www.linkedin.com/in/gorgina-polus  
- **GitHub:** github.com/GinaP77  
- **Email:** GorginaPolus7@outlook.com
